...
export type GetRoutingStepAggregateType<T extends RoutingStepAggregateArgs> = {
    [P in keyof T & keyof AggregateRoutingStep]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateRoutingStep[P]> : Prisma.GetScalarType<T[P], AggregateRoutingStep[P]>;
};
...
export type GetRoutingStepGroupByPayload<T extends RoutingStepGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<RoutingStepGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof RoutingStepGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], RoutingStepGroupByOutputType[P]> : Prisma.GetScalarType<T[P], RoutingStepGroupByOutputType[P]>;
}>>;
...
export type RoutingStepOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "routingTemplateId" | "stepOrder" | "operationName" | "defaultMachineType" | "estimatedMinutes" | "defaultMachineId", ExtArgs["result"]["routingStep"]>;
...
export type RoutingStepCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<RoutingStepFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface RoutingStepDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['RoutingStep'];
        meta: {
            name: 'RoutingStep';
        };
    };
     ...
     * })
    **/
    count<T extends RoutingStepCountArgs>(args?: Prisma.Subset<T, RoutingStepCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], RoutingStepCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends RoutingStepGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, RoutingStepGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRoutingStepGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**

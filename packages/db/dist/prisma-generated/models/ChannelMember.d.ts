...
export interface ChannelMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const channelMemberWithUserIdOnly = await prisma.channelMember.findMany({ select: { userId: true } })
     *
     */
     ...
     * })
     *
     * // Create many ChannelMembers and only return the `userId`
     * const channelMemberWithUserIdOnly = await prisma.channelMember.createManyAndReturn({
     *   select: { userId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     *
     * // Update zero or more ChannelMembers and only return the `userId`
     * const channelMemberWithUserIdOnly = await prisma.channelMember.updateManyAndReturn({
     *   select: { userId: true },
     *   where: {
     *     // ... provide filter here
     *   },

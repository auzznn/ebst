...
// @ts-nocheck 
/*
 * This file exports the `QcLog` model and its related types.
 *
...
export type GetQcLogAggregateType<T extends QcLogAggregateArgs> = {
      [P in keyof T & keyof AggregateQcLog]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateQcLog[P]>
    : Prisma.GetScalarType<T[P], AggregateQcLog[P]>
}
...
export type GetQcLogGroupByPayload<T extends QcLogGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<QcLogGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof QcLogGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], QcLogGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], QcLogGroupByOutputType[P]>
      }
    >
  >
...
export type QcLogCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<QcLogFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface QcLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['QcLog'], meta: { name: 'QcLog' } }
  /**
   ...
   * })
  **/
  count<T extends QcLogCountArgs>(
    args?: Prisma.Subset<T, QcLogCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], QcLogCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, QcLogGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetQcLogGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

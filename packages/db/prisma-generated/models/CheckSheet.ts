...
// @ts-nocheck 
/*
 * This file exports the `CheckSheet` model and its related types.
 *
...
export type GetCheckSheetAggregateType<T extends CheckSheetAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCheckSheet[P]>
    : Prisma.GetScalarType<T[P], AggregateCheckSheet[P]>
}
...
export type GetCheckSheetGroupByPayload<T extends CheckSheetGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CheckSheetGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CheckSheetGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CheckSheetGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CheckSheetGroupByOutputType[P]>
      }
    >
  >
...
export type CheckSheetCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface CheckSheetDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends CheckSheetCountArgs>(
    args?: Prisma.Subset<T, CheckSheetCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CheckSheetCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, CheckSheetGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCheckSheetGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

...
// @ts-nocheck 
/*
 * This file exports the `PartMaterial` model and its related types.
 *
...
export type GetPartMaterialAggregateType<T extends PartMaterialAggregateArgs> = {
      [P in keyof T & keyof AggregatePartMaterial]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePartMaterial[P]>
    : Prisma.GetScalarType<T[P], AggregatePartMaterial[P]>
}
...
export type GetPartMaterialGroupByPayload<T extends PartMaterialGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PartMaterialGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PartMaterialGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PartMaterialGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PartMaterialGroupByOutputType[P]>
      }
    >
  >
...
export type PartMaterialCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PartMaterialFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PartMaterialDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PartMaterial'], meta: { name: 'PartMaterial' } }
  /**
   ...
   * })
  **/
  count<T extends PartMaterialCountArgs>(
    args?: Prisma.Subset<T, PartMaterialCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PartMaterialCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PartMaterialGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PartMaterialGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPartMaterialGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

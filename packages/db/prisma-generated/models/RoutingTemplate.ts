...
// @ts-nocheck 
/*
 * This file exports the `RoutingTemplate` model and its related types.
 *
...
export type GetRoutingTemplateAggregateType<T extends RoutingTemplateAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateRoutingTemplate[P]>
    : Prisma.GetScalarType<T[P], AggregateRoutingTemplate[P]>
}
...
export type GetRoutingTemplateGroupByPayload<T extends RoutingTemplateGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<RoutingTemplateGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof RoutingTemplateGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], RoutingTemplateGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], RoutingTemplateGroupByOutputType[P]>
      }
    >
  >
...
export type RoutingTemplateCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface RoutingTemplateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends RoutingTemplateCountArgs>(
    args?: Prisma.Subset<T, RoutingTemplateCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], RoutingTemplateCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, RoutingTemplateGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRoutingTemplateGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

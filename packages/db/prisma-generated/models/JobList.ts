...
// @ts-nocheck 
/*
 * This file exports the `JobList` model and its related types.
 *
...
export type GetJobListAggregateType<T extends JobListAggregateArgs> = {
      [P in keyof T & keyof AggregateJobList]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateJobList[P]>
    : Prisma.GetScalarType<T[P], AggregateJobList[P]>
}
...
export type GetJobListGroupByPayload<T extends JobListGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<JobListGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof JobListGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], JobListGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], JobListGroupByOutputType[P]>
      }
    >
  >
...
export type JobListCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<JobListFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface JobListDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['JobList'], meta: { name: 'JobList' } }
  /**
   ...
   * })
  **/
  count<T extends JobListCountArgs>(
    args?: Prisma.Subset<T, JobListCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], JobListCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, JobListGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetJobListGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

...
const navItems = [
  ...
  { title: "Journal", href: "/accounting/journal", icon: BookOpen },
  { title: "Ledger", href: "/accounting/ledger", icon: FileSpreadsheet },
  { title: "Reports", href: "/accounting/reports", icon: BarChart3 },
  { title: "Assets", href: "/accounting/assets", icon: Building2 },
  { title: "Accounts", href: "/accounting/accounts", icon: ListTree },
];

          ...
          <DialogContent>
            ...
            <div className="space-y-4 pt-2">
                  ...
                  <div className="border rounded-lg overflow-hidden shadow-sm">
                    ...
                    {searchResults?.map((user) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm font-medium">{user.name} <span className="font-light text-xs">({user.displayUsername})</span></p>
              ...
              <Button
                ...
                disabled={createChannel.isPending || !channelName.trim() || selectedUsers.length === 0}
              >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <CardTitle className="text-base font-medium">
                          {channel.isDM
                            ? channel.members.find((m) => m.user.id !== session?.user.id)?.user.name ?? 'Unknown'
                            : `# ${channel.name}`
                          }
                        </CardTitle>
                        {channel.isDM && (
